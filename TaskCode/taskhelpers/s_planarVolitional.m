...
if ~Data.ErrorID,
    ...
    if TaskFlag==1, % If imagined movements
        switch Params.Arduino.planar.target
            case 0
                OptimalCursorTraj = [...
                    GenerateCursorTraj(Params.Arduino.planar.pos(1),StartTargetPos,Params.ImaginedMvmtTime,Params);
                    GenerateCursorTraj(StartTargetPos,StartTargetPos,Params.TargetHoldTime,Params)];
                ct = 1;
            otherwise
                OptimalCursorTraj = [...
                    GenerateCursorTraj(Params.Arduino.planar.pos(1),ReachTargetPos,Params.ImaginedMvmtTime,Params);
